          ...
          <div>
            <div className="flex items-end justify-center gap-2.5">
              <div className="flex h-[200px] w-[60px] flex-col justify-end lg:h-[300px] lg:w-[140px]">
                <span className="txt-b-bold text-center">{scoreStats.seAvg}</span>
                <div
              ...
              <div className="w-[50px] lg:w-[120px]">
                ...
                >
                  <span>Gap_SR</span>
                  <span>
                    ({scoreStats.gapSrAvg > 0 ? '+' : ''}{' '}
                    {scoreStats.gapSrAvg.toFixed(1)})
                  </span>
                </div>
              </div>
              <div className="flex h-[200px] w-[60px] flex-col justify-end lg:h-[300px] lg:w-[140px]">
                <span className="txt-b-bold text-center">{scoreStats.sjAvg}</span>
                <div
              ...
              <div className="w-[50px] lg:w-[120px]">
                ...
                >
                  <span>Gap_SB</span>
                  <span>
                    ({scoreStats.gapSbAvg > 0 ? '+' : ''}{' '}
                    {scoreStats.gapSbAvg.toFixed(1)})
                  </span>
                </div>
              </div>
              <div className="flex h-[200px] w-[60px] flex-col justify-end lg:h-[300px] lg:w-[140px]">
                <span className="txt-b-bold text-center">{scoreStats.bhAvg}</span>
                <div
        ...
        {competencyStats.map((competency) => {
          ...
          return (
            <div
              ...
              className="flex w-[300px] flex-col lg:w-[500px]"
            >
