...
const cards: { icon: LucideIcon; title: string; description: string }[] = [
  {
    ...
    title: '현재 수준 가시화',
    description:
      '조직의 AX 현재 수준과 역량 분포를 진단 결과 기준으로 한눈에 확인할 수 있습니다.\n막연한 감이나 일부 사례가 아니라, 현재 어디에서 시작해야 하는지 객관적인 기준으로 파악할 수 있습니다.',
  },
  {
    icon: PackageOpen,
    title: '우선 과제 명확화',
    description:
      '무엇을 먼저 보완해야 하는지, 어떤 역량을 우선 강화해야 하는지 더 명확하게 정리할 수 있습니다.\n진단 결과를 바탕으로 우선순위를 구분해, 실행 가능한 다음 과제를 설정할 수 있습니다.',
  },
  {
    icon: Map,
    title: '교육 설계의 구체화',
    description:
      '진단 결과를 바탕으로 기관 수준에 맞는 커리큘럼과 학습 흐름을 더 구체적으로 설계할 수 있습니다.\n공통 교육을 반복하는 것이 아니라, 현재 수준과 보완 포인트에 맞는 학습 방향을 제안할 수 있습니다.',
  },
  {
    icon: Repeat,
    title: '반복 가능한 성장 구조 확보',
    description:
      '진단, 학습, 전후 비교, 다음 단계 제안을 하나의 흐름으로 반복하며 지속적인 AX 성장 구조를 만들 수 있습니다.\n한 번의 교육으로 끝나는 것이 아니라, 다음 단계까지 이어지는 전환 구조를 설계할 수 있습니다.',
  },
];
