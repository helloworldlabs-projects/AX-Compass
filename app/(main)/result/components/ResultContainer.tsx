...
import { ResultCodeCard } from '@/app/(main)/result/components/ResultCodeCard';
import { ScoreStatGuideModal } from '@/app/(main)/result/components/modal/ScoreStatGuideModal';
import { ProfileTypeGuideModal } from '@/app/(main)/result/components/modal/ProfileTypeGuideModal';
import { LearningRoadmapGuideModal } from '@/app/(main)/result/components/modal/LearningRoadmapGuideModal';
...
export default function ResultContainer({ resultType, result }: ResultContainerProps) {
  ...
  return (
    <>
      <SectionNav type="result" groups={NAV_GROUPS} />
      <Container>
        <div
          data-print-hidden
        ...
        <Section id="competency-grade" className="w-full max-w-[700px]">
        ...
        <Section id="competency-score" className="max-w-[700px] lg:max-w-[1000px]">
                ...
                <div className="flex items-end justify-center gap-2.5">
                  ...
                  <div className="w-[50px] lg:w-[120px]">
                    ...
                    >
                      <span>Gap_SR</span>
                      <span>
                        ({result.scoreStats.gapSr > 0 ? '+' : ''}{' '}
                        {result.scoreStats.gapSr.toFixed(1)})
                      </span>
                  ...
                  <div className="w-[50px] lg:w-[120px]">
                    ...
                    >
                      <span>Gap_SB</span>
                      <span>
                        ({result.scoreStats.gapSb > 0 ? '+' : ''}{' '}
                        {result.scoreStats.gapSb.toFixed(1)})
                      </span>
                      <div className="flex w-full items-center">
                        <div className="h-px flex-1 bg-current" />
                        <div className="h-0 w-0 border-y-[5px] border-l-8 border-y-transparent border-l-current" />
              ...
              <div className="mx-auto flex max-w-[700px] flex-col gap-6">
                <div>
                  ...
                  <div>
                    ...
                    <br />
                    <span className="txt-b-bold text-red-500">[음수(−)]</span> 상황판단이
                    자기평가보다 높아, 스스로를 보수적으로 평가하거나 실제 판단이 더 강한 경향이
                    있습니다.
                  </div>
                </div>
                <div>
                  ...
                  <div>
                    ...
                    <br />
                    <span className="txt-b-bold text-red-500">[음수(−)]</span> 행동빈도가
                    상황판단보다 높아, 실행은 많지만 판단·검증이 따라오지 않을 수 있는 경향이
                    있습니다.
                  </div>
                </div>
              </div>
        ...
        <Section id="profile-type-stats" className="max-w-[700px]">
          <div className="flex w-full max-w-[700px] items-center justify-between">
            <div className="flex items-center gap-4">
        ...
        <Section id="learning-roadmap" className="max-w-[700px] lg:max-w-[1000px]">
          <div className="flex w-full max-w-[700px] items-center justify-between">
            <div className="flex items-center gap-4">
