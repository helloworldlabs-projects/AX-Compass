    ...
    <Section>
      ...
      <div className="flex flex-col gap-[30px]">
        <div className="flex max-w-[1470px] flex-wrap gap-[30px]">
          <div className="border-special-navy-100 flex h-fit flex-1 flex-col gap-6 rounded-[20px] border bg-white p-6 lg:min-w-[500px] lg:gap-[30px] lg:p-[50px]">
            <Quote
          ...
          <div className="flex flex-1 flex-col gap-[30px] lg:min-w-[500px]">
